 ...
 *	@author Wison
 */
public class MySwitchs extends CompoundButton {
     ...
     */
    public MySwitchs(Context context) {
        this(context, null);
    }
     ...
     */
    public MySwitchs(Context context, AttributeSet attrs) {
     ...
     */
    public MySwitchs(Context context, AttributeSet attrs, int defStyle) {
        ...
        // off-on 模式ﺿ图片模式或文字模式，图片模式是用Track背景图片表示off-on的状态，文字模式是用文字来表示off-on状倣?
        ...
        if (checkTrackOffOnDrawable()) {
            ...
            mTrackDrawable = a.getDrawable(R.styleable.Switch_mtrack);
        }

        mThumbDrawable = a.getDrawable(R.styleable.Switch_thumb);
        mTextOn = a.getText(R.styleable.Switch_mtextOn);
        mTextOff = a.getText(R.styleable.Switch_mtextOff);
        mThumbTextPadding = a.getDimensionPixelSize(R.styleable.Switch_mthumbTextPadding, 0);
        mSwitchMinWidth = a.getDimensionPixelSize(R.styleable.Switch_mswitchMinWidth, 0);

        mSwitchMinHeight = a.getDimensionPixelSize(R.styleable.Switch_switchMinHeight, 0);

        mSwitchPadding = a.getDimensionPixelSize(R.styleable.Switch_mswitchPadding, 0);

        int appearance = a.getResourceId(R.styleable.Switch_mswitchTextAppearance, 0);
        if (appearance != 0) {
